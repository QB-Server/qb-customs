...
18: Emergency   19: Military    20: Commercial  21: Trains
 ...
 Config.Locations = {
     ...
     ['Popular'] = {
         ...
         blip = {
             label = 'Bennys Motorworks',
             coords = vector3(799.72, -969.82, 26.4),
             sprite = 72,
             scale = 0.65,
             color = 0,
             display = 4,
         ...
         restrictions = { deniedClasses = { 18 } },
         zones = {
             { coords = vector3(830.02, -953.51, 25.44), length = 6.0, width = 4.0, heading = 51.11, minZ = 21.0, maxZ = 27.0 },
             { coords = vector3(830.06, -945.09, 25.43), length = 6.0, width = 4.0, heading = 90.31, minZ = 21.0, maxZ = 27.0 },
             { coords = vector3(830.52, -936.13, 25.44), length = 6.0, width = 4.0, heading = 139.41, minZ = 21.0, maxZ = 27.0 },
             { coords = vector3(821.54, -936.64, 25.44), length = 6.0, width = 4.0, heading = 215.77, minZ = 21.0, maxZ = 27.0 },
             { coords = vector3(813.27, -943.06, 25.44), length = 6.0, width = 4.0, heading = 216.06, minZ = 21.0, maxZ = 27.0 }
         }
     },
     ...
     ['Pillbox'] = {
         ...
         zones = {
             { coords = vector3(330.1, -557.57, 28.51), length = 9.4, width = 4.2, heading = 250.54, minZ = 25.5, maxZ = 33.5 },
         }
     },
 }